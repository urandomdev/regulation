...
func (_q *RuleQuery) QueryUser() *UserQuery {
...
func (_q *RuleQuery) QueryTargetAccount() *AccountQuery {
...
func (_q *RuleQuery) QueryExecutions() *RuleExecutionQuery {
...
func (_q *RuleQuery) WithUser(opts ...func(*UserQuery)) *RuleQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *RuleQuery) WithTargetAccount(opts ...func(*AccountQuery)) *RuleQuery {
	query := (&AccountClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RuleQuery) WithExecutions(opts ...func(*RuleExecutionQuery)) *RuleQuery {
	query := (&RuleExecutionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RuleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Rule, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *Rule, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTargetAccount; query != nil {
		if err := _q.loadTargetAccount(ctx, query, nodes, nil,
			func(n *Rule, e *Account) { n.Edges.TargetAccount = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withExecutions; query != nil {
		if err := _q.loadExecutions(ctx, query, nodes,
			func(n *Rule) { n.Edges.Executions = []*RuleExecution{} },
			func(n *Rule, e *RuleExecution) { n.Edges.Executions = append(n.Edges.Executions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RuleQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Rule, init func(*Rule), assign func(*Rule, *User)) error {
...
func (_q *RuleQuery) loadTargetAccount(ctx context.Context, query *AccountQuery, nodes []*Rule, init func(*Rule), assign func(*Rule, *Account)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Rule)
	for i := range nodes {
...
func (_q *RuleQuery) loadExecutions(ctx context.Context, query *RuleExecutionQuery, nodes []*Rule, init func(*Rule), assign func(*Rule, *RuleExecution)) error {
	...
	query.Where(predicate.RuleExecution(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(rule.ExecutionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *RuleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(rule.FieldUserID)
		}
		if _q.withTargetAccount != nil {
			_spec.Node.AddColumnOnce(rule.FieldTargetAccountID)
		}
	}
